...
-- Indexes
CREATE INDEX idx_businesses_auth_user_id ON public.businesses(auth_user_id);
CREATE INDEX idx_businesses_slug ON public.businesses(slug);
CREATE INDEX idx_businesses_city_slug ON public.businesses(city_slug);
CREATE INDEX idx_businesses_legacy_contractor_id ON public.businesses(legacy_contractor_id);
