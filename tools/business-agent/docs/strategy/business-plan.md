...
**Core Promise:** Build a professional portfolio in under 5 minutes per project.

**Messaging Pillars:**
1. **You already did the work—now show it off.** No writing, no typing, just talk.
2. **Your work is the hero.** Every project becomes shareable proof of quality.
3. **A portfolio that builds itself.** Voice-first, fast, and always up to date.

**What we DON'T promise:**
- We do NOT pitch lead generation as the primary benefit
- SEO and homeowner traffic are strategic (our GTM), not the contractor value prop
- The benefit is having proof to share with clients, not "we'll send you leads"

**Strategic note:** We will index pages and drive homeowner traffic, but this is *our* acquisition channel, not *their* promise. If leads happen, great—but we sell ease and credibility.

## 6) Pricing & Packaging (Validated)
...
### Pricing Validation (January 2026)

**Decision:** $29/mo confirmed. Price point validated against market research.

**Market Context:**
| Category | Benchmark |
|----------|-----------|
| Website builders (Wix, Squarespace) | $23-39/mo |
| Field service entry tier (Jobber) | $29/mo |
| Lead gen spend (Angi, Thumbtack) | $15-120/lead, ~$200/mo avg |
| Contractor marketing spend | 3-7% of revenue |

**Why $29/mo works:**
- Matches Jobber's familiar anchor price for trades
- Below Wix Business ($39) and Houzz Pro (~$65)
- Trivial vs. lead gen costs ($29/mo < cost of 1-2 bad leads)
- For a $500K contractor, $348/yr = 1-2% of marketing budget

**Messaging (do NOT promise leads):**
> "Build a portfolio in under 5 minutes per project. You already did the work—now show it off."
