...
export default function ProfileEditPage() {
  ...
  async function onSubmit(data: ProfileFormData) {
    setIsSaving(true);
    try {
      // Map form fields to new API field names
      ...
      // Only include slug if it was explicitly modified
      if (form.formState.dirtyFields.profile_slug) {
        apiPayload.slug = data.profile_slug;
      }
