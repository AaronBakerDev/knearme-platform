...
| **Business Profile** | `app/(portfolio)/businesses/[city]/[slug]/page.tsx` | `getContractorProfile()` → Supabase `contractors` + `projects` | SSR (dynamic) |
...
- [x] **Contractor profile pages**
  ...
  - File: `app/(portfolio)/businesses/[city]/[slug]/page.tsx`
...
| **`app/(portfolio)/businesses/[city]/[slug]/page.tsx`** | Business profile page template |
